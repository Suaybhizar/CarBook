...
namespace CarBook.WebApi.Controllers
{
    ...
    public class StatisticsController : ControllerBase
    {
        ...
        [HttpGet("GetCarCountByKmDrivenLessThan1000")]
        public async Task<IActionResult> GetCarCountByKmDrivenLessThan1000()
        {
            var values = await _mediator.Send(new GetCarCountByKmDrivenLessThan1000Query());
            return Ok(values);
        }
